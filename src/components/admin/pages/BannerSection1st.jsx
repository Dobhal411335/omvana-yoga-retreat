...
import { PencilIcon, Trash2Icon, LayoutTemplate, UploadCloud, Link as LinkIcon, Image as ImageIcon, Smartphone } from "lucide-react";
    ...
    return (
        <div className="w-full max-w-[1400px] mx-auto space-y-8 p-6 font-sans pb-24">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-2">
                <div>
                    <h1 className="text-2xl font-semibold tracking-tight text-slate-900">First Banner Section</h1>
                    <p className="text-sm text-slate-500 mt-1">Manage desktop and mobile images for the first promotional section.</p>
                </div>
                {editBanner && (
                    <Button type="button" variant="outline" onClick={() => {
                        setEditBanner(null);
                        setFormData({ buttonLink: "", image: { url: "", key: "" }, mobileImage: { url: "", key: "" } });
                        ...
                        <CardHeader className="border-b border-slate-50 bg-white/50 pb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <CardTitle className="text-lg font-semibold text-slate-800">
                                    {editBanner ? "Edit First Banner Section" : "Add New First Banner Section"}
                                </CardTitle>
                            </div>
                    ...
                    <Card className="rounded-[20px] border-slate-100 shadow-sm bg-white overflow-hidden h-full">
                        <CardHeader className="border-b border-slate-50 bg-white/50 pb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <CardTitle className="text-lg font-semibold text-slate-800">Existing First Banner Sections</CardTitle>
                            </div>
