...
const Checkout = ({ packages }) => {
    ...
    const handleImageChange = async (e, index, category) => {
        ...
        try {
            ...
            setHeliFormData(prev => {
                ...
                updatedCategory[index] = {
                    ...updatedCategory[index],
                    idProof: { url: data.url, key: data.key || "", loading: false },
                };
                return { ...prev, [category]: updatedCategory };
            });
    ...
    const handleDeleteImage = async (index, category) => {
        ...
        if (!fileKey) {
            setHeliFormData(prev => {
                const updatedCategory = [...prev[category]];
                updatedCategory[index] = { ...updatedCategory[index], idProof: { url: "", key: "", loading: false } };
                return { ...prev, [category]: updatedCategory };
            });
            return;
        }
                        ...
                        if (verificationResponse.data.success) {
                            try {
                                await axios.post("/api/brevo", {
                                    ...
                                    //             <td style="padding: 8px 0; text-align: right; font-weight: 700; color: #111827;">${formatNumber(advancePayment)}</td>
                                    //           </tr>
                                    //           <tr>
                    ...
                    <div className="flex flex-col gap-8 font-barlow">
                        ...
                        <div className="space-y-4 p-8 bg-blue-100 rounded-xl border-2 border-blue-300 h-fit">
                            ...
                            <div className="space-y-8 pt-8">
                                ...
                                <p>Email: <Link href={"mailto:care@kagpremiumhomes.com"} className="text-blue-600 font-semibold">Info@kagpremiumhomes.com</Link> or call <Link href={"tel:+918006000325"} className="text-blue-600 font-semibold"> +91 8006000325</Link></p>
                            </div>
                        </div>
                    </div>
                )}
