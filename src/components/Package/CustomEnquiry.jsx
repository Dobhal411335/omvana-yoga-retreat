                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="space-y-4 p-8 bg-blue-100 rounded-xl border-2 border-blue-300 h-fit">
                            ...
                            <div className="space-y-8 pt-8">
                                ...
                                <p>Email: <Link href={"mailto:care@kagpremiumhomes.com"} className="text-blue-600 font-semibold">Cnfo@kagpremiumhomes.com</Link> or call <Link href={"tel:+918006000325"} className="text-blue-600 font-semibold"> +91 8006000325</Link></p>
                            </div>
                        </div>
                    </div>
                )}
