...
import { DEFAULT_EMAIL_BRANDING, wrapEmailTemplate } from "@/lib/emailTemplate"
...
export default function TourPackageCalculator({ packages, plans }) {
    ...
    const companyDomain = new URL(DEFAULT_EMAIL_BRANDING.websiteUrl).hostname
    ...
    const handleImageChange = async (e, index, category) => {
        ...
        setHeliFormData(prev => {
            ...
            updatedCategory[index] = {
                ...updatedCategory[index],
                idProof: { ...updatedCategory[index].idProof, loading: true },
            };
            return { ...prev, [category]: updatedCategory };
        });
        ...
        try {
            ...
            setHeliFormData(prev => {
                ...
                updatedCategory[index] = {
                    ...updatedCategory[index],
                    idProof: { ...updatedCategory[index].idProof, loading: false },
                };
                return { ...prev, [category]: updatedCategory };
            });
        } finally {
    ...
    const handleDeleteImage = async (index, category) => {
        ...
        try {
            const res = await fetch("/api/cloudinary", {
                ...
                body: JSON.stringify({ publicId: fileKey }),
            });
        ...
        try {
            ...
            script.onload = () => {
                                    ...
                                    htmlContent: wrapEmailTemplate({
                                        ...
                                        bodyContent: `
                                          <div style="text-align: center; margin-bottom: 24px;">
                                            <p style="margin: 0 0 8px 0; color: #6b7280; font-size: 13px; text-transform: uppercase; letter-spacing: 0.08em;">Payment successful</p>
                                            <h2 style="margin: 0; font-size: 24px; color: #111827;">Thank you, ${formData.fullName}</h2>
                                            <p style="margin: 8px 0 0 0; color: #4b5563;">Your payment for <strong>${packages.packageName}</strong> has been completed successfully.</p>
                                          </div>

                                          <div style="background-color: #f8f9fa; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
                                            <h3 style="margin: 0 0 16px 0; font-size: 18px; color: #111827;">Transaction Details</h3>
                                            <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
                                              <tr>
                                                <td style="padding: 8px 0; color: #6b7280;">Amount</td>
                                                <td style="padding: 8px 0; text-align: right; font-weight: 700; color: #111827;">${formatNumber(advancePay)}</td>
                                              </tr>
                                              <tr>
                                                <td style="padding: 8px 0; color: #6b7280;">Payment ID</td>
                                                <td style="padding: 8px 0; text-align: right; font-weight: 600; color: #111827;">${verificationResponse.data.paymentId}</td>
                                              </tr>
                                              <tr>
                                                <td style="padding: 8px 0; color: #6b7280;">Payment Method</td>
                                                <td style="padding: 8px 0; text-align: right; font-weight: 600; color: #111827; text-transform: uppercase;">${verificationResponse.data.paymentMethod || 'N/A'}</td>
                                              </tr>
                                              <tr>
                                                <td style="padding: 8px 0; color: #6b7280;">Paid On</td>
                                                <td style="padding: 8px 0; text-align: right; font-weight: 600; color: #111827;">${new Date().toLocaleString()}</td>
                                              </tr>
                                              <tr>
                                                <td style="padding: 8px 0; color: #6b7280;">Email</td>
                                                <td style="padding: 8px 0; text-align: right; font-weight: 600; color: #111827;">${formData.email}</td>
                                              </tr>
                                              <tr>
                                                <td style="padding: 8px 0; color: #6b7280;">Mobile Number</td>
                                                <td style="padding: 8px 0; text-align: right; font-weight: 600; color: #111827;">${formData.mobile}</td>
                                              </tr>
                                            </table>
                                          </div>

                                          <p style="margin: 0; color: #374151; line-height: 1.6; text-align: center;">For any order related queries please reach out to <a href="mailto:${DEFAULT_EMAIL_BRANDING.email}" style="color: #2563eb; text-decoration: none;">${DEFAULT_EMAIL_BRANDING.email}</a> or call <a href="tel:+918006000325" style="color: #2563eb; text-decoration: none;">+91 8006000325</a>.</p>

                                           <div style="margin-top: 24px; text-align: center;">
                            <a href="${DEFAULT_EMAIL_BRANDING.websiteUrl}profile/orders" style="display: inline-block; background-color: #10B981; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 700;">View Your Account</a>
                          </div>
                                        `,
                                    }),
                                })
                ...
                const handlePaymentFailed = async (response) => {
                    ...
                    const emailMessage = wrapEmailTemplate({
                        title: 'Payment Failed',
                        branding: DEFAULT_EMAIL_BRANDING,
                        accentColor: '#EF4444',
                        bodyContent: `
                          <div style="text-align: center; margin-bottom: 24px;">
                            <p style="margin: 0 0 8px 0; color: #6b7280; font-size: 13px; text-transform: uppercase; letter-spacing: 0.08em;">Payment could not be processed</p>
                            <h2 style="margin: 0; font-size: 24px; color: #111827;">Hello, ${formData.fullName}</h2>
                            <p style="margin: 8px 0 0 0; color: #4b5563;">Your recent payment for <strong>${packages.packageName}</strong> was not completed.</p>
                          </div>

                          <div style="background-color: #f8f9fa; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
                            <h3 style="margin: 0 0 16px 0; font-size: 18px; color: #111827;">Transaction Attempt Details</h3>
                            <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
                              <tr>
                                <td style="padding: 8px 0; color: #6b7280;">Amount</td>
                                <td style="padding: 8px 0; text-align: right; font-weight: 700; color: #111827;">₹${formatNumber(advancePay)}</td>
                              ...
                              <tr>
                                <td style="padding: 8px 0; color: #6b7280;">Payment ID</td>
                                <td style="padding: 8px 0; text-align: right; font-weight: 600; color: #111827;">${error.metadata?.payment_id || 'N/A'}</td>
                              </tr>
                              <tr>
                                <td style="padding: 8px 0; color: #6b7280;">Payment Method</td>
                                <td style="padding: 8px 0; text-align: right; font-weight: 600; color: #111827;">${error.source || 'N/A'}</td>
                              </tr>
                              <tr>
                          ...
                          <p style="margin: 0 0 12px 0; color: #374151; line-height: 1.6;">Reason: ${error.description || 'Payment failed'}</p>
                          ...
                          <p style="margin: 24px 0 0 0; color: #374151; line-height: 1.6; text-align: center;">For any order related queries please reach out to <a href="mailto:${DEFAULT_EMAIL_BRANDING.email}" style="color: #2563eb; text-decoration: none;">${DEFAULT_EMAIL_BRANDING.email}</a> or call <a href="tel:+918006000325" style="color: #2563eb; text-decoration: none;">+91 8006000325</a>.</p>

                          <div style="margin-top: 24px; text-align: center;">
                            <a href="https://kagpremiumhomes.com/profile/orders" style="display: inline-block; background-color: #10B981; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 700;">View Your Account</a>
                          </div>
                        `
                    })
                                ...
                                <div key={index} className="space-y-4 p-4 bg-white rounded-lg border border-gray-200">
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            type="file"
                                            accept="image/*"
                                            onChange={(e) => handleImageChange(e, index, "adults")}
                                            className="outline-none border-2 border-blue-600 bg-transparent focus-visible:ring-0 focus:ring-0 focus-visible:outline-none focus:outline-none"
                                        />
                                        {heliFormData.adults[index]?.idProof?.loading && (
                                            <p className="mt-2 text-sm text-blue-600">Uploading image...</p>
                                        )}
                                        {heliFormData.adults[index]?.idProof?.url && (
                                            <div className="mt-2 relative overflow-hidden rounded-lg border border-gray-200 aspect-video">
                                                <Image
                                ...
                                <div key={index} className="space-y-4 p-4 bg-white rounded-lg border border-gray-200">
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            type="file"
                                            accept="image/*"
                                            onChange={(e) => handleImageChange(e, index, "children")}
                                            className="outline-none border-2 border-blue-600 bg-transparent focus-visible:ring-0 focus:ring-0 focus-visible:outline-none focus:outline-none"
                                        />
                                        {heliFormData.children[index]?.idProof?.loading && (
                                            <p className="mt-2 text-sm text-blue-600">Uploading image...</p>
                                        )}
                                ...
                                <div key={index} className="space-y-4 p-4 bg-white rounded-lg border border-gray-200">
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            type="file"
                                            accept="image/*"
                                            onChange={(e) => handleImageChange(e, index, "infants")}
                                            className="outline-none border-2 border-blue-600 bg-transparent focus-visible:ring-0 focus:ring-0 focus-visible:outline-none focus:outline-none"
                                        />
                                        {heliFormData.infants[index]?.idProof?.loading && (
                                            <p className="mt-2 text-sm text-blue-600">Uploading image...</p>
                                        )}
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="space-y-4 p-8 bg-blue-100 rounded-xl border-2 shadow-2xl border-blue-300 h-fit">
                            ...
                            <div className="space-y-8 pt-8">
                                ...
                                <p>Email: <Link href={`mailto:${DEFAULT_EMAIL_BRANDING.email}`} className="text-blue-600 font-semibold">{DEFAULT_EMAIL_BRANDING.email}</Link> or visit <Link href={DEFAULT_EMAIL_BRANDING.websiteUrl} className="text-blue-600 font-semibold">{companyDomain}</Link></p>
                            </div>
                        </div>
                    </div>
                )}
